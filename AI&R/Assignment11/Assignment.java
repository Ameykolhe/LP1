...
public class Assignment
{
    ...
    public Assignment(int numberOfNodes)
    {
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            Assignment assignment = new Assignment(number_of_vertices);
            assignment.bestFirstSearch(adjacency_matrix, heuristicvalues,source);
